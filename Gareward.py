...
def im():
                 img3=ImageTk.PhotoImage(Image.open ("C:/Users/DELL/Desktop/DLi/LOGO/other/p1.jfif"))
...
def display():
       ...
       labelExample2.pack()
       lab1.pack()
       #buttonL=tk.Button(frame, text ="----- CHOOSE A OPTION TO GET YOUR CODE----",fg="white", bg = "BLACK")
